...
ax.plot([10,20,40,80], [1600,800,400,200], label="ideal strong scaling", color="xkcd:goldenrod", linestyle="--")
...
plt.text(77,3000,"5% of Perlmutter ",horizontalalignment='right')#,color='darkgray',fontweight='bold')
