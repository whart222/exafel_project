...
DATA_DIR=/global/project/projectdirs/lcls/d/psdm/cxi/${EXP}/demo/xtc
...
cctbx_args="input.experiment=${EXP} input.run_num=${RUN} output.logging_dir=${OUT_DIR} output.output_dir=${OUT_DIR} format.cbf.invalid_pixel_mask=${IN_DIR}/mask.pickle ${PWD}/tmp/process_batch.phil dump_indexed=False output.tmp_output_dir=${OUT_DIR} input.xtc_dir=${DATA_DIR}"
